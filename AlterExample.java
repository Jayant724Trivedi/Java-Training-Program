...
public class AlterExample {
		public static void main(String[] args) throws Exception {
			...
			if (choice == 1) {
				...
				String alter = "alter table Student1 change " + oldColName + " " + newColName + " " + datatype;
				...
				System.out.println("enter the datatype of new colname:");
				String datatype = sc.next();
				String alter = "alter table Student1 add "+ newColName + " " + datatype;
				int a = st.executeUpdate(alter);
				if (a == 0)
					System.out.println("altered");
			}else if(choice == 3) {
				...
				String newColName = sc.next();
				String alter = "alter table Student1 drop column "+ newColName ;
				int a = st.executeUpdate(alter);
				if (a == 0)
					System.out.println("altered");
			}
